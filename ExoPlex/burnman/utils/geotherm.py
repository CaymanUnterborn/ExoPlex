...
"""
table_brown = read_table("/Users/ctunterborn/Desktop/ExoPlex/ExoPlex/burnman/data/input_geotherm/brown_81.txt")
table_brown_depth = np.array(table_brown)[:, 0]
table_brown_temperature = np.array(table_brown)[:, 1]

table_anderson = read_table("/Users/ctunterborn/Desktop/ExoPlex/burnman/data/input_geotherm/anderson_82.txt")
table_anderson_depth = np.array(table_anderson)[:, 0]
table_anderson_temperature = np.array(table_anderson)[:, 1]

table_stacey_c = read_table("/Users/ctunterborn/Desktop/ExoPlex/burnman/data/input_geotherm/Stacey_1977_continents.txt")
table_stacey_c_depth = np.array(table_stacey_c)[:, 0]
table_stacey_c_temperature = np.array(table_stacey_c)[:, 1]

table_stacey_o = read_table("/Users/ctunterborn/Desktop/ExoPlex/burnman/data/   input_geotherm/Stacey_1977_oceans.txt")
